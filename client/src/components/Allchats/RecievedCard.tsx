...
const RecievedCard = ({ user,handlesubmit, loading }: any) => {
  ...
  return (
    <div className=" flex p-2 mb-2  border-b-1 border-b-zinc-300  ">
      ...
      <div className="flex  ml-auto">
        <button className="text-xs rounded-lg  px-3  py-2 mx-2 cursor-pointer transition-all ease-in-out hover:bg-yellow-300 bg-yellow-400 text-zinc-100 ">
          Accept
        </button> 
